...
parser.add_argument('--dir', type=str, nargs=1,
        help='Directory of input pickled files,which contains two subdirectories (MC and Data) generated by hist_sort.py', required=True)
...
for var in variables.keys():
    ...
    for pt_label in pt_labels:
        ...
        # Plotting MC
        print '...processing MC histograms...'
        ...
        for flavor in ['BB', 'BL', 'CC', 'CL', 'LL']:
            ...
            with open(os.path.join(directory, 'MC', var, hist_tag_name), 'rb') as f:
                hist_post_tag = pickle.load(f)
            with open(os.path.join(directory, 'MC', var, hist_notag_name), 'rb') as f:
